...
*
* \funcusage
*  \snippet redLED_SUT.c usage_redLED_Write
*******************************************************************************/
...
*
* \funcusage
*  \snippet redLED_SUT.c usage_redLED_SetDriveMode
*******************************************************************************/
...
*
* \funcusage
*  \snippet redLED_SUT.c usage_redLED_Read  
*******************************************************************************/
...
* preferred redLED_Read() API because the 
* redLED_ReadDataReg() reads the data register instead of the status 
...
*
* \funcusage
*  \snippet redLED_SUT.c usage_redLED_ReadDataReg 
*******************************************************************************/
...
/* If interrupt is connected for this Pins component */ 
    ...
    /*******************************************************************************
    * Function Name: redLED_SetInterruptMode
    ****************************************************************************//**
    *
    ...
    *  component. Or you may use redLED_INTR_ALL to configure the
    *  interrupt mode of all the pins in the Pins component.       
    *  - redLED_0_INTR       (First pin in the list)
    *  - redLED_1_INTR       (Second pin in the list)
    *  - ...
    *  - redLED_INTR_ALL     (All pins in Pins component)
    *
    * \param mode
    ...
    *
    * \funcusage
    *  \snippet redLED_SUT.c usage_redLED_SetInterruptMode
    *******************************************************************************/
    void redLED_SetInterruptMode(uint16 position, uint16 mode)
    {
		if((position & redLED_0_INTR) != 0u) 
		{ 
			 redLED_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *
    * \funcusage
    *  \snippet redLED_SUT.c usage_redLED_ClearInterrupt
    *******************************************************************************/
