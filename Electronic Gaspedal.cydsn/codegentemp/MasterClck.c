...
/*******************************************************************************
* Function Name: MasterClck_Start
********************************************************************************
*
* Summary:
...
void MasterClck_Start(void) 
{
    ...
    MasterClck_CLKEN |= MasterClck_CLKEN_MASK;
	MasterClck_CLKSTBY |= MasterClck_CLKSTBY_MASK;
}


/*******************************************************************************
* Function Name: MasterClck_Stop
********************************************************************************
*
* Summary:
...
void MasterClck_Stop(void) 
{
    ...
    MasterClck_CLKEN &= (uint8)(~MasterClck_CLKEN_MASK);
	MasterClck_CLKSTBY &= (uint8)(~MasterClck_CLKSTBY_MASK);
}
...
/*******************************************************************************
* Function Name: MasterClck_StopBlock
********************************************************************************
*
* Summary:
...
{
    if ((MasterClck_CLKEN & MasterClck_CLKEN_MASK) != 0u)
    {
        ...
        CLK_DIST_AMASK = MasterClck_CLKEN_MASK;
        CLK_DIST_DMASK = 0x00u;
#else
        CLK_DIST_DMASK = MasterClck_CLKEN_MASK;
        CLK_DIST_AMASK = 0x00u;
#endif /* MasterClck__CFG3 */

        /* Clear mask of bus clock. */
        CLK_DIST_BCFG2 &= (uint8)(~BCFG2_MASK);

        oldDivider = CY_GET_REG16(MasterClck_DIV_PTR);
        ...
        CLK_DIST_LD = 0x00u;
        CY_SET_REG16(MasterClck_DIV_PTR, oldDivider);
#endif /* HAS_CLKDIST_LD_DISABLE */
    }
}
...
/*******************************************************************************
* Function Name: MasterClck_StandbyPower
********************************************************************************
*
* Summary:
...
/*******************************************************************************
* Function Name: MasterClck_SetDividerRegister
********************************************************************************
*
* Summary:
                                ...
                                
{
    ...
    uint8 currSrc = MasterClck_GetSourceRegister();
    uint16 oldDivider = MasterClck_GetDividerRegister();

    if (clkDivider != oldDivider)
    {
        enabled = MasterClck_CLKEN & MasterClck_CLKEN_MASK;
        ...
        else
        {
            ...
            if (enabled != 0u)
            {
                ...
                if (((MasterClck_MOD_SRC & CYCLK_SYNC) == 0u) || (clkDivider == 0u))
                {
#if HAS_CLKDIST_LD_DISABLE
                    CY_SET_REG16(CYREG_CLKDIST_WRK0, oldDivider);
                    CLK_DIST_LD = CYCLK_LD_DISABLE|CYCLK_LD_SYNC_EN|CYCLK_LD_LOAD;
...
/*******************************************************************************
* Function Name: MasterClck_GetDividerRegister
********************************************************************************
*
* Summary:
...
{
    return CY_GET_REG16(MasterClck_DIV_PTR);
}


/*******************************************************************************
* Function Name: MasterClck_SetModeRegister
********************************************************************************
*
* Summary:
...
{
    MasterClck_MOD_SRC |= modeBitMask & (uint8)MasterClck_MODE_MASK;
}


/*******************************************************************************
* Function Name: MasterClck_ClearModeRegister
********************************************************************************
*
* Summary:
...
{
    MasterClck_MOD_SRC &= (uint8)(~modeBitMask) | (uint8)(~(uint8)(MasterClck_MODE_MASK));
}


/*******************************************************************************
* Function Name: MasterClck_GetModeRegister
********************************************************************************
*
* Summary:
...
{
    return MasterClck_MOD_SRC & (uint8)(MasterClck_MODE_MASK);
}


/*******************************************************************************
* Function Name: MasterClck_SetSourceRegister
********************************************************************************
*
* Summary:
...
{
    uint16 currDiv = MasterClck_GetDividerRegister();
    uint8 oldSrc = MasterClck_GetSourceRegister();
        ...
        (clkSource == ((uint8)CYCLK_SRC_SEL_CLK_SYNC_D))) && (currDiv == 0u))
    {
        ...
        MasterClck_MOD_SRC |= CYCLK_SSS;
        MasterClck_MOD_SRC =
            (MasterClck_MOD_SRC & (uint8)(~MasterClck_SRC_SEL_MSK)) | clkSource;
    }
...
/*******************************************************************************
* Function Name: MasterClck_GetSourceRegister
********************************************************************************
*
* Summary:
...
{
    return MasterClck_MOD_SRC & MasterClck_SRC_SEL_MSK;
}
...
/*******************************************************************************
* Function Name: MasterClck_SetPhaseRegister
********************************************************************************
*
* Summary:
...
{
    MasterClck_PHASE = clkPhase & MasterClck_PHASE_MASK;
}


/*******************************************************************************
* Function Name: MasterClck_GetPhase
********************************************************************************
*
* Summary:
...
{
    return MasterClck_PHASE & MasterClck_PHASE_MASK;
}
